...
BOT_USERNAME = os.getenv("BOT_USERNAME")  # اسم البوت بدون @
CHANNEL_USERNAME = os.getenv("CHANNEL_USERNAME")  # القناة الإجبارية مع @

MIN_WITHDRAW = 0.0001  # أقل مبلغ للسحب
TASK_REWARD = 0.000025  # مكافأة تنفيذ كل مهمة
DAILY_REWARD = 0.00001  # مكافأة المطالبة اليومية
REF_PERCENT = 0.20  # نسبة مكافأة الإحالة 20%
